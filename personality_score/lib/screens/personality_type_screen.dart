    ...
    return AppBar(
            ...
            child: Row(
              ...
              children: [
                ...
                DropdownButton<String>(
                  ...
                  items: [
                    DropdownMenuItem(value: "a", child: Text("a", style: TextStyle(color: Colors.white, fontFamily: 'Roboto'))),
                    DropdownMenuItem(value: "b", child: Text("b", style: TextStyle(color: Colors.white, fontFamily: 'Roboto'))),
                  ],
                  onChanged: (value) {},
                  hint: Text("Team Description", style: TextStyle(color: Colors.white, fontFamily: 'Roboto')),
                ),
              ],
            ),
          ),
      ...
      actions: [
        ...
        ElevatedButton(
          ...
          child: Text('Take the Test ->', style: TextStyle(color: Colors.white, fontFamily: 'Roboto')),
        ),
      ],
    );
  }
